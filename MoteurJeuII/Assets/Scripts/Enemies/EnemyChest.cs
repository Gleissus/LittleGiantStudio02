...
public class EnemyChest : Enemies
{
    ...
    void Update()
    {
        if (!isAttacking && isInRange && Input.GetKeyDown(KeyCode.E)) // Check if the player is within range, the chest monster is not attacking, and the player presses the interact button (E key)
        {
